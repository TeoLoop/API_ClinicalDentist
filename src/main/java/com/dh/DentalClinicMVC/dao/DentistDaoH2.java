...
public class DentistDaoH2 implements IDao<Dentist>{
    ...
    private final static String SQL_SELECT_ID = "SELECT * FROM DENTISTS WHERE ID =?";

    private static final String SQL_UPDATE = "UPDATE DENTISTS SET REGISTRATION =?, NAME=?, LASTNAME=? WHERE ID =?";
